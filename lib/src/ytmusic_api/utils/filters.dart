...
bool isTitle(dynamic data) {
  return traverseString(data, ["musicVideoType"])?.startsWith("MUSIC_VIDEO_TYPE_") ?? false;
}

/// Verifica se um objeto representa um artista.
bool isArtist(dynamic data) {
  final pageType = traverseString(data, ["pageType"]);
  return ["MUSIC_PAGE_TYPE_USER_CHANNEL", "MUSIC_PAGE_TYPE_ARTIST"].contains(pageType);
}
